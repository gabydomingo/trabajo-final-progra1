...
def mostrar_menu_comida() -> Tuple:
    """ Lee el csv.
        ...
        returns:
                lineas: Una tupla con un matriz con el archivo sin el primer indice
                encabezado: Una tupla con una lista que solo contiene el primer indice de la matriz
    """
    try:
...
def hacer_pedido(lineas: List, encabezado: List) -> None:
